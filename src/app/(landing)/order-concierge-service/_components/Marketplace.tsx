...
export default function Marketplace() {
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold">Concierge Marketplace</h2>
      <p className="mt-3 text-sm font-light opacity-70">
        Premium hizmetler ve özel deneyimlerden oluşan seçkimizle yaşam tarzınızı geliştirin. Günlük ihtiyaçlardan özel organizasyonlara kadar her şey özenle hazırlanmıştır.
      </p>
