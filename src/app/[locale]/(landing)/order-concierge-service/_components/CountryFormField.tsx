      ...
      render={({ field, fieldState: { error } }) => (
        <FormItem>
          ...
          <Popover open={isOpen} onOpenChange={setIsOpen}>
            ...
            >
              <Command>
                <CommandInput placeholder={t("search_country", { defaultValue: "Search country..." })} className="h-9" />
                <CommandList>
                  <CommandEmpty>{t("country_not_found", { defaultValue: "Country not found." })}</CommandEmpty>
                  <CommandGroup>
