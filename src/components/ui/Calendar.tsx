...
function Calendar({
  ...
  const _dayButtonClassName = cn(
    ...
    "size-8 rounded-md p-0 font-normal transition-none hover:bg-neutral-700! aria-selected:opacity-100",
  ...
  const _selectedClassName = cn(
    "[&>button]:text-primary-foreground [&>button]:hover:text-primary-foreground [&>button]:bg-primary [&>button]:hover:bg-primary",
