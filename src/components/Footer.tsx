        ...
        <div className="grid gap-x-16 gap-y-10 md:grid-cols-2 lg:grid-cols-5">
          <div className="flex flex-col lg:col-span-3">
            <div className="flex flex-col gap-x-16 gap-y-10 xl:flex-row">
              ...
              <div className="flex flex-col">
                <Link href="/partnerships" className="w-fit text-sm leading-6 font-light text-primary underline-offset-2 hover:underline">Partnerlikler</Link>
                <Link href="/chargeback-policy" className="w-fit text-sm leading-6 font-light text-primary underline-offset-2 hover:underline">Chargeback Politikası</Link>
                <Link href="/payment-policy" className="w-fit text-sm leading-6 font-light text-primary underline-offset-2 hover:underline">Ödeme Politikası</Link>
                <Link href="/privacy-policy" className="w-fit text-sm leading-6 font-light text-primary underline-offset-2 hover:underline">Gizlilik Politikası</Link>
                <Link href="/terms-of-service" className="w-fit text-sm leading-6 font-light text-primary underline-offset-2 hover:underline">Hizmet Şartları</Link>
                <Link href="/refund-and-cancellation-policy" className="w-fit text-sm leading-6 font-light text-primary underline-offset-2 hover:underline">İade ve İptal Politikası</Link>
              </div>
            </div>
            <div className="mt-10 text-sm font-light opacity-70">© {new Date().getFullYear()} The Illustrious Company Limited. Tüm hakları saklıdır.</div>
          </div>
          <div className="flex flex-col gap-4 lg:col-span-2 lg:col-start-4">
            <p className="text-sm leading-6 font-light opacity-70">Registration number: 15776513<br />Registered office address:<br />Dept 3965 43 Owston Road<br />Carcroft, Doncaster, DN6 8DA<br />United Kingdom</p>
